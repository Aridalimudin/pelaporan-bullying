        ...
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full">
            ...
            <div class="space-y-4 delay-3 animate-slide-up">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-2">
                    ...
                    <a href="{{ route('lapor.contact') }}" class="px-6 py-3 bg-white text-gray-800 rounded-xl font-semibold text-base shadow-lg hover-lift flex items-center justify-center gap-2 border-2 border-gray-200">
